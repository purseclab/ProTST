...
if __name__ == "__main__":
    ...
    FUNC_END = 2
    len_limit = int(512)
    data_dir = f'data/binkit2/obf_instfunc_bound/funcbound'
    saveloc = f'workdir/4_prepare_finetune_dataset/obf/funcbound/{len_limit}/1_9'
    ...
    for category, files in file_lists.items():
        ...
        selected_files.extend(files[:int(len(files) * 0.04)])
