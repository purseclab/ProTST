...
if __name__ == "__main__":
    ...
    if args.dataset_arch == 'x86':
        args.dataset_pt = f'workdir/4_prepare_finetune_dataset/x86/instbound/{args.input_length}/{dataset_split}'
        projectname = f"GBME_instbound_{dataset_split}_{args.backbone.lower()}_{model_size}_x64->x86"
    elif args.dataset_arch == 'all':
        args.dataset_pt = f'workdir/4_prepare_finetune_dataset/all_architecture/instbound/{args.input_length}/{dataset_split}'
        projectname = f"GBME_instbound_{dataset_split}_{args.backbone.lower()}_{model_size}_allarch"
    else:
