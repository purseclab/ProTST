...
if __name__ == "__main__":
    ...
    if args.dataset_arch == 'obf':
        args.dataset_pt = f'workdir/4_prepare_finetune_dataset/obf/funcbound/{args.input_length}/{dataset_split}'
        projectname = f"GBME_funcbound_{dataset_split}_{args.backbone.lower()}_{model_size}_obf"
    else:
