...
if __name__ == "__main__":
    ...
    obf_method = 'all'
    assert obf_method in args.model_path, "wrong path"

    if args.dataset_arch == 'obf':
        args.dataset_pt = f'workdir/4_prepare_finetune_dataset/obf/funcsim/{obf_method}/{dataset_split}'
        projectname = f"GBME_funcsim_{dataset_split}_{args.backbone.lower()}_{model_size}_obf"
    else:
    ...
    name_list = ['funcsim', args.backbone.lower(),obf_method]
    ...
    for epoch in range(args.logistic_start_epoch, args.logistic_epochs):
        ...
        if epoch % args.validation_epoch == 0:
            ...
            if pool_size_mrr_record['32'] > best_mrr_32 or pool_size_mrr_record['1000'] > best_mrr_10000:
