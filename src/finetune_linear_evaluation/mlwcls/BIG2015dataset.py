...
class BIG2015Dataset(Dataset):
    """BIG2015 dataset"""
    def __init__(self, args, split):
        self.tokenized_dataset = load_from_disk(os.path.join(args.BIG2015_dataset_dir, split))
        args.label_list = ['Ramnit','Lollipop','Kelihos_ver3','Vundo','Simda','Tracur','Kelihos_ver1','Obfuscator.ACY','Gatak']
